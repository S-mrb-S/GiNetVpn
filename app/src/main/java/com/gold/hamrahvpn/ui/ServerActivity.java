...
public class ServerActivity extends Activity implements FinishActivityListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (defaultItemDialog == 0) {
            newDefaultConfigValue = "V2ray";
        } else if (defaultItemDialog == 1) {
            newDefaultConfigValue = "OpenVpn";
        } else {
            newDefaultConfigValue = "No config found";
        }
        textViewCenter.setText(newDefaultConfigValue);
